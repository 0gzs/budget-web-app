...
const Header = () => {
    ...
    return (
        <header className='w-full lg:w-[120px] lg:px-1 lg:h-full bg-[#181D20] fixed
                top-0 lg:bottom-0 left-0 right-0 shadow-inner flex lg:flex-col justify-between
                items-center z-20 px-4 lg:py-10'>

            {help && (
                <div className='modal'>
                    <div className='w-[340px] lg:w-[800px] p-4 bg-carbon flex flex-col space-y-2 lg:space-y-0 lg:flex-row items-center rounded-md'>
                        <div className='w-full lg:w-2/3'>
                            <img src={currentImage} className="w-full" alt="More information" />
                        </div>
                        <div className='w-full lg:w-1/3 flex flex-col lg:h-[375px] lg:justify-center space-x-2'>
                            ...
                            <div className='form-btn-group px-2 flex flexl-col items-center'>
                                {currentImage === helpImage ? (
                                    <>
            ...
            <ul className='flex items-center lg:flex-col lg:space-y-2 justify-end max-w-[200px] lg:w-fit'>
                <h1 className='text-white text-center font-bold hover:cursor-pointer flex items-center' onClick={viewHelp}>Help <span className='py-1 px-2.5 bg-white/20 rounded-full'>?</span></h1>
                <li>
